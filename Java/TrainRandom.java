...
public class TrainRandom {
	...
	public static void main(String[] args) throws IOException {
		...
		df.setMaximumFractionDigits(2);
			...
			SerialPort port = SerialPort.getCommPort("dev/cu.wchusbserial1420");
			System.out.println(port.getSystemPortName());
			port.setBaudRate(115200);
			System.out.println(port.openPort());
			port.setComPortTimeouts(SerialPort.TIMEOUT_READ_SEMI_BLOCKING, 0, 0);
			
			FileWriter fw = new FileWriter(new File("/Users/omarali/Documents/Bachelor/DataSets/DataSet1.txt"), true);
			...
			while(true)
			{
				...
				label = (int)(Math.random() * (10 + 26)) + 48;
				
				if(label > 57)
					label += 39;
				System.out.println("Write the Character " + (char)label);
